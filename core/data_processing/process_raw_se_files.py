...
raw_file = "/home/bogdan/projects/PASTEL/data/mtl/CR_all.columns_10.17.22.xlsx"
df_raw = pandas.read_excel(raw_file)

labeled_file = "/home/bogdan/projects/self-explanations/git_resources/new_english_se2_enhanced.csv"
...
for t in texts:
    ...
    for s in sents:
        print(s, len(df_t[df_t["SentNo"]==s]))
        print(df_t[df_t["SentNo"]==s].head(1))
        print(df_t[df_t["SentNo"]==s].head(1)['TargetSentence'])
...
df_raw.to_excel("/home/bogdan/projects/PASTEL/data/mtl/CR_all.columns_10.17.22_enhanced.xlsx")
print(sent_dict)